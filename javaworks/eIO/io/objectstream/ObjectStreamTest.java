...
//			
			...
			DataVO data = new DataVO(name,age,height,bloodType);
	...
	void readData() {
		...
		*/
			try{
				...
				DataVO data = (DataVO)ois.readObject();

				tfName.setText(String.valueOf(data.getName()));
				tfAge.setText(String.valueOf(data.getAge()));
				tfHeight.setText(String.valueOf(data.getHeight()));
				tfBloodType.setText(String.valueOf(data.getBloodType()));
